...
public class SimilarImageSearch {
	...
	/*public static void main(String[] args) {
		...
		System.out.println(differences+"45456");*/
	...
	public static String produceFingerPrint(String filename) {
		Log.i("test", filename+"");
		Bitmap source = ImageHelper.getBitmap(filename);// 读取文件
		...
		Bitmap thumb = ImageHelper.extractMiniThumb(source, width, height, false);
